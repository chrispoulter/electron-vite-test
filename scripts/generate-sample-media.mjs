...
const tvShows = [
  ...
  {
    folder: 'The Bear',
    episodes: ['The Bear S01E01.m4v', 'The Bear S01E02.m4v', 'The Bear S02E01.mov']
  },
  {
    folder: 'Severance',
    episodes: ['Severance S01E01.mkv', 'Severance S01E02.mkv', 'Severance S02E01.avi']
  }
]
...
const generate = async () => {
  ...
  console.log(`Created ${fileIndex} placeholder media files with staggered modified times.`)
}
